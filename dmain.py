...
def send_click(i):
    ...
    elif i==3: response= "그렇죠! 다양한 맛을 즐길 수 있다니... 넘 매력적이네요ㅎㅎ 어떤 토핑을 젤 좋아하나요?"
    elif i==4: response= "감자 토핑을 젤 좋아하는군요:) 감자 맛있죠ㅋㅋㅋㅋ 피자를 좋아하는 다른 이유도 있나요??"
    elif i==5: response= "헉 맞네요...! 피자 혼자 먹긴 어렵죠ㅋㅋ 그리고 다 함께 먹으면 기분도 더 좋아지잖아요?!"
